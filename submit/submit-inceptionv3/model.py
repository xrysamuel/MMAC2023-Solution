...
class model:
    def __init__(self):
        self.checkpoint = "inceptionv3_best.pth"
    ...
    def load(self, dir_path):
        ...
        :return:
        """
        self.model = InceptionV3Classifier(num_classes=5, pretrained=False)
        # join paths
...
class InceptionV3Classifier(nn.Module):
    def __init__(self, num_classes: int = 5, pretrained: bool = True):
        ...
        if pretrained:
            ...
            self.inception = inception_v3(weights=Inception_V3_Weights.IMAGENET1K_V1, aux_logits=True, dropout=0.9)
            logger.info("Initialized InceptionV3 with ImageNet pre-trained weights.")
        else:
            self.inception = inception_v3(weights=None, aux_logits=True, dropout=0.9)
